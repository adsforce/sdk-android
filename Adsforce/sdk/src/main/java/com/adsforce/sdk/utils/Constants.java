...
public class Constants {
    ...
    public static final String SP_SETTING_FILE_NAME = "adsforce_setting_file";
    ...
    public static final String SP_INSTALL_FILE_NAME = "adsforce_install_file";
    ...
    public static final String SP_DEEPLINK_FILE_NAME = "adsforce_deeplink_file";
    ...
    public static final String SP_EVENT_FILE_NAME = "adsforce_event_file";
    ...
    public static final String ACTION_SESSION = "active";
    public static final String ACTION_REVENUE = "revn";
